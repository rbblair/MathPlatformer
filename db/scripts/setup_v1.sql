...
CREATE TABLE IF NOT EXISTS `answers` (
  ...
  `data_format` int(10) unsigned NOT NULL,
  `answer_data` blob NOT NULL,
  PRIMARY KEY (`id`),
  KEY `fk_answers_data_format_id` (`data_format`),
  CONSTRAINT `fk_answers_data_format_id` FOREIGN KEY (`data_format`) REFERENCES `data_formats` (`id`)
...
CREATE TABLE IF NOT EXISTS `avatars` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_avatar_data_format_id` (`data_format`),
  CONSTRAINT `fk_avatar_data_format_id` FOREIGN KEY (`data_format`) REFERENCES `data_formats` (`id`)
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;

-- Data exporting was unselected.
-- Dumping structure for table math_sucks.data_formats
CREATE TABLE IF NOT EXISTS `data_formats` (
  `id` int(10) unsigned NOT NULL AUTO_INCREMENT,
  `format_name` varchar(8) DEFAULT NULL,
  PRIMARY KEY (`id`),
